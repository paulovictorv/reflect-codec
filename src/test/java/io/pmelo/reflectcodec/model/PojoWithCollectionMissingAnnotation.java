package io.pmelo.reflectcodec.model;
...
public class PojoWithCollectionMissingAnnotation {
    ...
    @JsonCreator
    public PojoWithCollectionMissingAnnotation(@JsonProperty("strings") Set<String> strings,
    ...
    public boolean equals(Object o) {
        ...
        PojoWithCollectionMissingAnnotation that = (PojoWithCollectionMissingAnnotation) o;
